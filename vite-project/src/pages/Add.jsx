...
function Add({ token }) {
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault(); // ✅ FIXED: added `e` as parameter
    ...
    try {
      ...
      formData.append("sizes", JSON.stringify(sizes)); // ✅ FIXED: corrected typo from JOSN
    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='flex gap-2 mt-2'>
        <input
          ...
          id="bestseller"
          checked={bestseller}
          onChange={(e) => setBestseller(e.target.checked)} // ✅ safer checkbox binding
        />
